...
Class Install extends CI_Controller {
    ...
    function __construct()
    {
        ...
        if(file_exists(FCPATH.'shop/config/database.php'))
        {
            redirect('/');
        }
    ...
    function index()
    {
        ...
        $data['is_writeable']['config'] = is_writeable(FCPATH.'shop/config/');
        ...
        else
        {
            ...
            if (is_resource($this->db->conn_id) OR is_object($this->db->conn_id))
            {
                ...
                write_file(FCPATH.'shop/config/database.php', $file_contents);
                ...
                write_file(FCPATH.'shop/config/config.php', $file_contents);
